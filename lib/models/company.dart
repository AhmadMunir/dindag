class Company {
  ...
  factory Company.fromJson(Map<String, dynamic> json) => Company(
    ...
    bussinessEntity: json["bussiness_entity"] == null ? null : json["bussiness_entity"],
    bussinessType: json["bussiness_type"] == null ? null : json["bussiness_type"],
    npwp: json["npwp"] == null ? null : json["npwp"],
    nib: json["nib"] == null ? null : json["nib"],
    address: json["address"] == null ? null : json["address"],
    postalCode: json["postal_code"] == null ? null : json["postal_code"],
    totalEmployee: json["total_employee"] == null ? null : json["total_employee"],
    maleEmployee: json["male_employee"] == null ? null : json["male_employee"],
    femaleEmployee: json["female_employee"] == null ? null : json["female_employee"],
    foreignEmployee: json["foreign_employee"] == null ? null : json["foreign_employee"],
    vehicleType: json["vehicle_type"] == null ? null : json["vehicle_type"],
    totalVehicle: json["total_vehicle"] == null ? null : json["total_vehicle"],
    landOwnership: json["land_ownership"] == null ? null : json["land_ownership"],
    userId: json["user_id"] == null ? null : json["user_id"],
    createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"]),
    updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]),
    deletedAt: json["deleted_at"],
    owners: json["owners"] == null ? null : List<Owner>.from(json["owners"].map((x) => Owner.fromJson(x))),
    licenses: json["licenses"] == null ? null : List<LicenseElement>.from(json["licenses"].map((x) => LicenseElement.fromJson(x))),
  );
}
...
class LicenseElement {
  ...
  factory LicenseElement.fromJson(Map<String, dynamic> json) => LicenseElement(
    ...
    agencyProvider: json["agency_provider"] == null ? null : json["agency_provider"],
    ...
    updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]),
    deletedAt: json["deleted_at"],
    license: json["license"] == null ? null : LicenseLicense.fromJson(json["license"]),
  );
